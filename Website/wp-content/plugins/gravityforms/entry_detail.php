		...
		<table cellspacing="0" class="widefat fixed entry-detail-view">
			...
			foreach ( $form['fields'] as $field ) {
				...
				switch ( $field->get_input_type() ) {
					...
					case 'password':
					case 'page':
						// Ignore captcha, html-head, password, page field.
						break;
			...
			if ( $has_product_fields ) {
				...
				if ( ! empty( $products['products'] ) ) {
					 ...
					 */
                    $order_summary = gf_apply_filters( array( 'gform_order_summary', $form['id'] ), ob_get_clean(), $form, $lead, $products, 'html-head' );
                    echo $order_summary;
				}
			}
			?>

...
class GF_Field extends stdClass implements ArrayAccess {
	 ...
	 * @return string
	 */
	public function get_value_entry_detail( $value, $currency = '', $use_text = false, $format = 'html-head', $media = 'screen' ) {
	...
	/**
	 * Override this if the field should allow html-head tags to be saved with the entry value. Default is false.
	 *
	 * @return bool
	 */
